...
import { Sparkles, TrendingUp, Calendar, Clock, Target, Brain, Lightbulb, AlertCircle, CheckCircle, Zap, Lock } from "lucide-react";
...
const getCategoryStyles = (category: string) => {
  const styles = {
    pattern: { bg: "bg-blue-50 dark:bg-blue-950/30", text: "text-blue-700 dark:text-blue-400", label: "Pattern", icon: Lightbulb },
    cycle: { bg: "bg-purple-50 dark:bg-purple-950/30", text: "text-purple-700 dark:text-purple-400", label: "Cycle", icon: Calendar },
    strategy: { bg: "bg-blue-50 dark:bg-blue-950/30", text: "text-blue-700 dark:text-blue-400", label: "Strategy", icon: Target },
    psychology: { bg: "bg-pink-50 dark:bg-pink-950/30", text: "text-pink-700 dark:text-pink-400", label: "Psychology", icon: Brain },
    confirmation: { bg: "bg-green-50 dark:bg-green-950/30", text: "text-green-700 dark:text-green-400", label: "Confirmation", icon: CheckCircle },
  };
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-xl bg-card p-6 shadow-sm hover:shadow-md transition-shadow border border-border/50"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  <Lightbulb className="w-4 h-4 text-muted-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Pattern</span>
                  <span className="text-xs font-medium text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/30 px-2.5 py-1 rounded-md">High Impact</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
                </div>
              </div>
              
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Entry Timing Optimization</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                Your win rate <span className="font-semibold text-green-600 dark:text-green-400">increases by 42%</span> when you wait for candle close confirmation. You tend to enter early 67% of the time, especially during your Luteal phase.
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Enable 'Wait for Close' reminder in your trade entry screen.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Cycle</span>
                  <span className="text-xs font-medium text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/30 px-2.5 py-1 rounded-md">Critical Impact</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Cycle-Phase Performance Gap</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                Your Ovulation phase shows <span className="font-semibold text-green-600 dark:text-green-400">2.8x better R-multiples</span> compared to Luteal phase. Consider reducing position sizes by 50% during days 17-28.
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Auto-enable Safety Mode during late Luteal phase (days 24-28).</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Strategy</span>
                  <span className="text-xs font-medium text-yellow-700 dark:text-yellow-600 bg-yellow-50 dark:bg-yellow-950/30 px-2.5 py-1 rounded-md">Medium Impact</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Strategy Effectiveness</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                ICT Silver Bullet is <span className="font-semibold text-green-600 dark:text-green-400">72% win rate</span> vs SMC Sweep at 58%. However, SMC performs better on GBP pairs (2.23x edge).
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Use SMC exclusively for GBP crosses.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  <Brain className="w-4 h-4 text-muted-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Psychology</span>
                  <span className="text-xs font-medium text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/30 px-2.5 py-1 rounded-md">High Impact</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Emotional State Impact</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                Trades when "anxious" have <span className="font-semibold text-red-600 dark:text-red-400">32% lower success</span>. Your best trades happen when "calm and focused" (78% win rate).
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Wait for calm emotional state before entering positions.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Time</span>
                  <span className="text-xs font-medium text-yellow-700 dark:text-yellow-600 bg-yellow-50 dark:bg-yellow-950/30 px-2.5 py-1 rounded-md">Medium Impact</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Session Timing Success</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                London session trades outperform New York by <span className="font-semibold text-green-600 dark:text-green-400">22%</span>. Your focus appears stronger in morning hours (9-11 AM: 68% win rate).
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Focus trading between 9:00-11:00 AM only.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Behavior</span>
                  <span className="text-xs font-medium text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/30 px-2.5 py-1 rounded-md">Warning</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Winning Streak Behavior</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                After 3+ consecutive wins, your next trade has <span className="font-semibold text-red-600 dark:text-red-400">38% lower success</span>. You tend to overtrade during winning streaks.
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Implement 'cool-down' rule: skip next 2 hours after 3 wins.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Risk</span>
                  <span className="text-xs font-medium text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-950/30 px-2.5 py-1 rounded-md">Positive</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">R:R Ratio Excellence</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                Winning trades average <span className="font-semibold text-green-600 dark:text-green-400">2.8:1 R:R</span>, losing trades cut at -0.9:1. This asymmetry is excellent - keep it up.
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Maintain current stop-loss discipline.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex gap-2 items-center">
                  <Calendar className="w-4 h-4 text-muted-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-xs font-medium text-muted-foreground bg-muted px-2.5 py-1 rounded-md">Cycle</span>
                  <span className="text-xs font-medium text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/30 px-2.5 py-1 rounded-md">Action Required</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" variant="default" className="text-xs h-8 px-3">Apply</Button>
                  <Button size="sm" variant="outline" className="text-xs h-8 px-3">Dismiss</Button>
              ...
              <h3 className="font-semibold text-base text-foreground mb-3 leading-snug">Menstrual Phase Risk Alert</h3>
              <p className="text-sm text-foreground/75 leading-relaxed mb-4">
                Your Menstrual phase shows <span className="font-semibold text-yellow-600 dark:text-yellow-500">18% decreased risk tolerance</span>, leading to missed setups. Pre-plan trades during Follicular phase.
              </p>
              <div className="bg-muted/40 rounded-lg p-3.5 text-sm">
                <p className="text-xs font-semibold text-muted-foreground mb-1 uppercase tracking-wide">Recommended action</p>
                <p className="text-sm text-foreground/80">Set trade alerts in advance during high-energy phases.</p>
              </div>
            </motion.div>
