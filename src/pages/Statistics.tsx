                  ...
                  return (
                    <div key={weekIdx} className="grid grid-cols-8 gap-2">
                          ...
                          return (
                            <div
                              ...
                              className={`
                                ...
                                ${hasData && !isPositive ? 'border-red-500/60 bg-red-500/10' : ''}
                            ...
                            >
                              ...
                              {hasData && (
                                <div className="space-y-1">
                                  <div className={`text-xs font-bold ${isPositive ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
                      ...
                      <div className={`min-h-[80px] p-2 rounded-lg border flex flex-col items-center justify-center ${
                        ...
                        {weekHasData ? (
                          <>
                            <div className={`text-xs font-bold ${weekIsPositive ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
